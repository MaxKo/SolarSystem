 ...
 * @since 26 Feb 2009
 */
public class Solar3D extends GLCanvas implements GLEventListener {
     ...
     */
    public Solar3D(GLCapabilities capabilities, int width, int height) {
    ...
    public final static void main(String[] args) {
        ...
        Solar3D canvas = new Solar3D(capabilities, 800, 500);
